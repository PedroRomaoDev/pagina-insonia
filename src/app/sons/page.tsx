...
const sons = [
  {
    ...
    // URL de exemplo - substitua por áudio real
    audioUrl: "https://cdn.pixabay.com/download/audio/2022/05/13/audio_257112ce99.mp3"
  },
  {
    id: "mar",
    nome: "Mar",
    ...
    audioUrl: "https://cdn.pixabay.com/download/audio/2022/06/07/audio_c2eb9151ec.mp3"
  },
  {
    id: "floresta",
    nome: "Floresta",
    ...
    audioUrl: "https://cdn.pixabay.com/download/audio/2022/03/10/audio_4dedf26c94.mp3"
  },
  {
    id: "ventilador",
    nome: "Ventilador",
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <div className="space-y-12">
            ...
            {sons.map((som) => {
              ...
              return (
                <button
                  ...
                  className={`group relative bg-gradient-to-br ${som.cor} p-8 rounded-3xl border ${som.corBorda} ${som.corHover} transition-all duration-300 hover:scale-105 ${som.corSombra} text-left ${
                    estaTocando ? "ring-2 ring-white/50" : ""
                  }`}
                >
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-2xl font-bold text-white">{som.nome}</h3>
          ...
          <div className="bg-gradient-to-br from-purple-600/10 to-blue-600/10 rounded-3xl border border-purple-500/30 p-8">
            <h2 className="text-2xl font-bold mb-4 text-purple-300">Dicas de uso:</h2>
            <ul className="space-y-3 text-gray-200">
              ...
              <li className="flex items-start gap-3">
                <span className="text-purple-400">•</span>
                <span>Combine com a respiração guiada para melhores resultados</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-purple-400">•</span>
